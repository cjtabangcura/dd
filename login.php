            ...
            <div class="card card-body shadow-blur mx-3 mx-md-4 rounded-0">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-sm-6">
							<a href="http://localhost/pmms/LegalWebsiteTemplate/index.html" class="btn btn-primary bg-gradient rounded-0 mb-0">Home</a>
                            <a href="./registration.php" class="btn btn-primary bg-gradient rounded-0 mb-0">Create an Account</a>
                        </div>
